...
/* Formato:  tl_l  tr_l  bl_l  br_l  |  tl_r  tr_r  bl_r  br_r            */
/*           open_l  open_r  y_l  y_r  |  rt  rb  ct  cb  | ms  pr        */

#define FACE_NEUTRAL \
    ((face_params_t){   0,   0,   0,   0,    0,   0,   0,   0, \
                     1.00f,1.00f,   0,   0,  20,  20,   3,   3, \
                     FACE_EYE_COLOR, 500, 0 })

#define FACE_BLINK_HIGH \
    ((face_params_t){   0,   0,  28,  28,    0,   0,  28,  28, \
                     0.10f,0.10f, -18, -18,  20,  20,   0,   0, \
                     FACE_EYE_COLOR, 100, 1 })

#define FACE_HAPPY \
    ((face_params_t){  14,  14,  -8,  -8,   14,  14,  -8,  -8, \
                     0.32f,0.32f, -10, -10,   4,   4,  15, -15, \
                     FACE_EYE_COLOR, 400, 0 })

#define FACE_GLEE \
    ((face_params_t){  22,  22,  -6, -30,   22,  22, -30,  -6, \
                     0.28f,0.28f, -18, -18,   4,   4,  24, -24, \
                     FACE_EYE_COLOR, 400, 0 })
